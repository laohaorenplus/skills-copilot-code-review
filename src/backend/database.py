...
def init_database():
    ...
    if announcements_collection.count_documents({}) == 0:
        for announcement in initial_announcements:
            announcements_collection.insert_one(dict(announcement))
...
initial_announcements = [
    {
        "message": "🎉 Activity registration is now open! Sign up for your favorite extracurricular activities before spots fill up. All registrations close at the end of the month.",
        "start_date": None,
